...
def context():
    ...
    text =  """
            # Contexto
            Aquí presentamos nuestro contexto de la Obra de Lina Bo Bardi. MASP
            """
    st.write(text)

    label = "Pega aquí el texto fuente"
